...
class NotificationsConfig {
  ...
  Future showLembreteAt({String title, String body, Time time, int id = 0}) =>
      flutterLocalNotificationsPlugin.showDailyAtTime(
          id, title, body, time, _notificationDetails);

  Future showNotification({String title, String body, int id = 0}) =>
