...
@UseMoor(tables: [Bebidas, BebidaIngeridas], daos: [BebidaDao, BebidaIngeridaDao])
  ...
  MigrationStrategy get migration => MigrationStrategy(
      onCreate: (Migrator m) async {
        m.createAllTables().then((onValue) async {
          await into(bebidas).insert(Bebida(ml: 400, imagemCopo: "cup-400.svg", createdAt: DateTime.now(), updatedAt: DateTime.now()));
